...
- **Book identity resolution** (`store.Catalog.find`): every importer resolves a `BookRef`
  ...
  store.)
- **Flat note filenames** (`books/core/naming.py` — `next_free_stem`/`strip_subtitle`/`safe_filename`,
